...
<nav id="sidebar">
                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        <a href="<?php echo e(url('/opportunities')); ?>">
                ...
                <ul class="list-unstyled components">
                     ...
                     <li>
                        <a href="<?php echo e(url('/changepass')); ?>">
            ...
            <!-- Page Content Holder -->
            <div id="content">
  <h2 style="color:white;">Welcome to the Wintec Internship Portal, <?php echo e(Auth::user()->name); ?></h2>
                                ...
                                <p style="color:white;">Once there, you can select from one of the following </p>                
                                    <ul style="color:white;">
                                        ...
                                        <li><a href="<?php echo e(url('/opportunities')); ?>">Internships</a></li>
                                        <li><a href="<?php echo e(url('/opportunities')); ?>">Projects</a></li>
                                        <li><a href="<?php echo e(url('/opportunities')); ?>">Placements</a></li>
